...
export default function FAQ() {
  ...
  return (
    <div
      id="faq"
      className="relative z-10 h-fit md:pb-20 pb-16 px-4 sm:px-6 md:px-10 lg:px-12 bg-neutral-950 text-yellow"
    >
      <div className="reveal reveal-delay-1 mt-0 pt-20 flex-col font-bebas text-6xl xl:text-7xl">
        <h1 className="text-light-gray text-[55px] sm:text-[60px] md:text-[80px] uppercase">
          common
        </h1>
        <h1 className="text-[55px] sm:text-[60px] md:text-[80px] uppercase">
          questions
        </h1>
      </div>
            ...
            <div className="border-b-[0.5px] border-neutral-800" key={i}>
              ...
              >
                <div className="overflow-hidden">
                  <p className="pb-5 pr-10 font-DMSans text-base text-light-gray">
                    {faq.a}
                  </p>
                </div>
              </div>
