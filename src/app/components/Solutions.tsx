...
export default function Solutions() {
  const solutions = [
    {
      title: "Path",
      subtitle: "Entry Point → Prototype → Short Term Results",
      // items: [
    ...
    {
      title: "Circle",
      subtitle: "Ecosystem → Supervision / Coordination → Long Term Results",
      // items: [
      //   "Focusing on a specific part of the business community (Designated Community)",
      //   "Fully Strategy Plan",
      //   "Supervision",
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-0 pt-14 -mx-12">
        {solutions.map((s, i) => (
          <div
            key={i}
          ...
          >
            ...
            <div className="relative z-10 flex h-110 flex-col p-12">
              ...
              <h2 className="pt-2 font-DMSans text-2xl duration-500 delay-200 group-hover:text-neutral-700">
                {s.subtitle}
              </h2>
