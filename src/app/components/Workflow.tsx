  ...
  return (
    ...
    >
      ...
      <div className="reveal reveal-delay-1 mt-6 flex-col font-bebas text-7xl">
        <h1 className="text-light-gray uppercase">modular</h1>
      ...
      <div className="relative flex -top-10 right-60 justify-end">
        <Image
          ...
          className="absolute -right-27 transition-opacity duration-300 will-change-transform"
